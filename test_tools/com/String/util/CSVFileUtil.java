...
public class CSVFileUtil {
	...
	public static void main(String[] args) {
		String fileName = "./csv/things.csv";
		try {
			CSVFileUtil csvFileUtil = new CSVFileUtil(fileName);
			String ss = csvFileUtil.readLine();
			String s2 = csvFileUtil.readLine();
			String s3 = csvFileUtil.readLine();
			String s4 = csvFileUtil.readLine();
			System.out.println(csvFileUtil.fromCSVLinetoArray(ss).toString());
